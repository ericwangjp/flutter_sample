...
import 'package:flutter_sample/charts_commom/common.dart';
...
class SmoothLineChart extends StatelessWidget {
  ...
  const SmoothLineChart(this.seriesList, {super.key, this.animate = true});
  ...
  factory SmoothLineChart.withRandomData() {
    return SmoothLineChart(_createRandomData());
  }
