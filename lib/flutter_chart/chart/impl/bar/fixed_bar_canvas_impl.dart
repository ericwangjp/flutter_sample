...
import 'package:flutter_sample/flutter_chart/chart/canvas/base_canvas.dart';
...
import 'package:flutter_sample/flutter_chart/chart/impl/bar/fixed_bar_layout_impl.dart';
import 'package:flutter_sample/flutter_chart/chart/model/chart_data_bar.dart';

/// 绘制 bar
class FixedBarCanvasImpl extends BaseCanvas<ChartDataBar> {
  @override
  void draw({
    ...
    config as FixedBarLayoutConfig;
