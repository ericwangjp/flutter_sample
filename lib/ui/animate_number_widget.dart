...
class AnimateNumberWidget extends StatefulWidget {
  /// Desired start value.
  ...
  @override
  State<AnimateNumberWidget> createState() => _AnimateNumberWidgetState();
}

class _AnimateNumberWidgetState extends State<AnimateNumberWidget>
  ...
  @override
  void didUpdateWidget(covariant AnimateNumberWidget oldWidget) {
    controller.reset();
    controller.forward();
