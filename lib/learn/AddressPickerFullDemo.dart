...
import 'package:flutter_sample/learn/picker_test.dart';
...
class _MyHomePageState extends State<MyHomePage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: AddressPickWidget(stateText: stateText),
    );
  }
}

class AddressPickWidget extends StatefulWidget {
  AddressPickWidget({Key? key, this.stateText = ''}) : super(key: key);

  String stateText;

  @override
  State<AddressPickWidget> createState() => _AddressPickWidgetState();
}

class _AddressPickWidgetState extends State<AddressPickWidget> {
  @override
  Widget build(BuildContext context) {
    return Container(
  ...
  showPickerModal(BuildContext context) async {
    final result = await Picker(
        ...
        //   final wheelpicker = PickerWidget.of(context);
        //   return wheelpicker?.data?.title ?? Text("xxx");
        // },
  ...
  showPickerDateTime(BuildContext context) {
    Picker(
        ...
        onSelect: (Picker picker, int index, List<int> selected) {
          setState(() {
            widget.stateText = picker.adapter.toString();
          });
        }).showBottomSheet(context);
  }
