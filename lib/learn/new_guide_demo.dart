...
import '../commontest/guide_detail_page.dart';
    ...
    return MaterialApp(
      ...
      home: Scaffold(
        body: ShowCaseWidget(
          ...
          blurValue: 1,
          builder: Builder(builder: (context) => const MailGuidePage()),
...
class MailGuidePage extends StatefulWidget {
  const MailGuidePage({Key? key}) : super(key: key);

  @override
  State<MailGuidePage> createState() => _MailGuidePageState();
}

class _MailGuidePageState extends State<MailGuidePage> {
      ...
      onTap: () {
        Navigator.push<void>(
          ...
          MaterialPageRoute<void>(
            builder: (_) => const GuideDetailPage(),
          ),
        );
      },
      child: Container(
