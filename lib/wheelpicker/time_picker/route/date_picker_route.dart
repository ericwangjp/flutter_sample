...
import 'package:flutter_sample/wheelpicker/time_picker/model/date_item_model.dart';
import 'package:flutter_sample/wheelpicker/time_picker/model/date_mode.dart';
import 'package:flutter_sample/wheelpicker/time_picker/model/date_time_data.dart';
import 'package:flutter_sample/wheelpicker/time_picker/model/date_type.dart';
import 'package:flutter_sample/wheelpicker/time_picker/model/pduration.dart';
import 'package:flutter_sample/wheelpicker/time_picker/model/suffix.dart';
...
class _PickerState extends State<_PickerContentView> {
  ...
  Widget _renderPickerView() {
    ...
    if (!_pickerStyle.showTitleBar &&
        _pickerStyle.header == null &&
        _pickerStyle.footer == null) {
      return itemView;
    }
    ...
    if(_pickerStyle.showHeaderLine){
      viewList.add(_headerLineView());
    }
    if (_pickerStyle.header != null) {
      viewList.add(_pickerStyle.header!);
    }
    viewList.add(itemView);
    if (_pickerStyle.footer != null) {
      viewList.add(_pickerStyle.footer!);
    }
  ...
  /// 顶部分割线
  Widget _headerLineView() {
    return Container(
      height: _pickerStyle.headerLineHeight,
      decoration: BoxDecoration(color: _pickerStyle.dividerColor),
    );
  }
}
...
class _BottomPickerLayout extends SingleChildLayoutDelegate {
  ...
  BoxConstraints getConstraintsForChild(BoxConstraints constraints) {
    ...
    if (pickerStyle.showHeaderLine) {
      maxHeight += pickerStyle.headerLineHeight;
    }
    if (pickerStyle.header != null) {
      maxHeight += pickerStyle.headerHeight;
    }
    if (pickerStyle.footer != null) {
      maxHeight += pickerStyle.footerHeight;
    }
