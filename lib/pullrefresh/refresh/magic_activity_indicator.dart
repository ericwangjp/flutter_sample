...
class MagicActivityIndicator extends StatefulWidget {
  /// Creates an iOS-style activity indicator that spins clockwise.
  const MagicActivityIndicator({
    Key? key,
    this.animating = true,
  ...
  /// to 1.0.
  const MagicActivityIndicator.partiallyRevealed({
    Key? key,
    this.radius = _kDefaultIndicatorRadius,
    this.progress = 1.0,
  })  : assert(radius != null),
  ...
  @override
  State<MagicActivityIndicator> createState() => _CupertinoActivityIndicatorState();
}

class _CupertinoActivityIndicatorState extends State<MagicActivityIndicator>
  ...
  @override
  void didUpdateWidget(MagicActivityIndicator oldWidget) {
